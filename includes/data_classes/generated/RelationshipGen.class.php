<?php
	 ...
	 * @property integer $RelatedToPersonId the value for intRelatedToPersonId 
	 * @property integer $RelationshipTypeId the value for intRelationshipTypeId 
	 * @property Person $Person the value for the Person object referenced by intPersonId 
	 * @property Person $RelatedToPerson the value for the Person object referenced by intRelatedToPersonId 
	...
	class RelationshipGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Instantiate a new Relationship object and return it

			// Do we have to expand anything?
			if ($objQueryBuilder->ExpandAsArrayNodes) {
				$objToReturn = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Relationship::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNodes, $objToReturn, $objQueryBuilder->ColumnAliasArray);
				...
				return Relationship::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $objPreviousItem = null, $strColumnAliasArray = array()) {
			...
			$strAlias = $strAliasPrefix . 'related_to_person_id__victim_witness_num';
			$strAliasName = array_key_exists($strAlias, $strColumnAliasArray) ? $strColumnAliasArray[$strAlias] : $strAlias;
			if (!is_null($objDbRow->GetColumn($strAliasName)))
		...
		/**
		 * Instantiate a single Relationship object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return Relationship next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return Relationship::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, null, $strColumnAliasArray);
		}
		...
		*/
		...
		public function Journal($strJournalCommand) {
			$objDatabase = Relationship::GetDatabase()->JournalingDatabase;
		...
		public static function GetJournalForId($intId) {
			...
			$objResult = $objDatabase->Query('SELECT * FROM relationship WHERE id = ' .
				$objDatabase->SqlVariable($intId) . ' ORDER BY __sys_date');

			return Relationship::InstantiateDbResult($objResult);
		}
		...
		public function GetJournal() {
			return Relationship::GetJournalForId($this->intId);
		}
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'RelatedToPersonId':
					// Gets the value for intRelatedToPersonId 
					// @return integer
					return $this->intRelatedToPersonId;

				case 'RelationshipTypeId':
					// Gets the value for intRelationshipTypeId 
					// @return integer
				...
				case 'RelatedToPerson':
					// Gets the value for the Person object referenced by intRelatedToPersonId 
					// @return Person
					try {
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'RelatedToPersonId':
					// Sets the value for intRelatedToPersonId 
					// @param integer $mixValue
					// @return integer
					try {
				...
				case 'RelationshipTypeId':
					// Sets the value for intRelationshipTypeId 
					// @param integer $mixValue
					// @return integer
					try {
				...
				case 'RelatedToPerson':
					// Sets the value for the Person object referenced by intRelatedToPersonId 
					// @param Person $mixValue
					// @return Person
					if (is_null($mixValue)) {
						...
						$this->intRelatedToPersonId = $mixValue->VictimWitnessNum;
