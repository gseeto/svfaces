<?php
	...
	class PersonDataGridGen extends QDataGrid {
		...
		public function MetaAddEditLinkColumn($strLinkUrl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit', $intArgumentType = QMetaControlArgumentType::PathInfo) {
			switch ($intArgumentType) {
				case QMetaControlArgumentType::QueryString:
					$strLinkUrl .= '?intVictimWitnessNum=<?=urlencode($_ITEM->VictimWitnessNum)?>';
					break;
				case QMetaControlArgumentType::PathInfo:
					$strLinkUrl .= '/<?=str_replace("+","%20",urlencode($_ITEM->VictimWitnessNum))?>';
					break;
				default:
		...
		public function MetaAddEditProxyColumn(QControlProxy $pxyControl, $strLinkHtml = 'Edit', $strColumnTitle = 'Edit') {
			$strHtml = '<a href="#" <?= $_FORM->GetControl("' . $pxyControl->ControlId . '")->RenderAsEvents($_ITEM->VictimWitnessNum, false); ?>>' . QApplication::Translate($strLinkHtml) . '</a>';
			$colEditColumn = new QDataGridColumn(QApplication::Translate($strColumnTitle), $strHtml, 'HtmlEntities=False');
			$this->AddColumn($colEditColumn);
			return $colEditColumn;
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'VictimWitnessNum': return QQN::Person()->VictimWitnessNum;
				...
				case 'SocialSecurityNumber': return QQN::Person()->SocialSecurityNumber;
				case 'Phone': return QQN::Person()->Phone;
				case 'Email': return QQN::Person()->Email;
				case 'Notes': return QQN::Person()->Notes;
				case 'Gender': return QQN::Person()->Gender;
				case 'EthnicityId': return QQN::Person()->EthnicityId;
				case 'Ethnicity': return QQN::Person()->Ethnicity;
				case 'Age': return QQN::Person()->Age;
				case 'PrimaryLanguageId': return QQN::Person()->PrimaryLanguageId;
				case 'PrimaryLanguage': return QQN::Person()->PrimaryLanguage;
				case 'Disabled': return QQN::Person()->Disabled;
				case 'Elderly': return QQN::Person()->Elderly;
				case 'AgencyReferredId': return QQN::Person()->AgencyReferredId;
				case 'AgencyReferred': return QQN::Person()->AgencyReferred;
