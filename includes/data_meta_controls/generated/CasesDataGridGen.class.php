<?php
	 ...
	 * listing a collection of Cases objects.  It includes
	 ...
	 * 
	 */
	class CasesDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Cases datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Cases object, or it can be any QQNode extending from QQN::Cases().
		 * 
		 ...
		 * sorting using two fields from the Cases object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Cases
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Cases::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Cases, given the clauses above
			$this->DataSource = Cases::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Cases-based QQNode.
		 * It will also verify that it is a proper Cases-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'cases') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "cases".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Cases()->Id;
				case 'CrimeTypeId': return QQN::Cases()->CrimeTypeId;
				case 'CrimeDate': return QQN::Cases()->CrimeDate;
				case 'AgencyReportedToId': return QQN::Cases()->AgencyReportedToId;
				case 'AgencyReportedTo': return QQN::Cases()->AgencyReportedTo;
				case 'CrimeReportNumber': return QQN::Cases()->CrimeReportNumber;
				case 'FamilyLawNumber': return QQN::Cases()->FamilyLawNumber;
				case 'CourtId': return QQN::Cases()->CourtId;
				case 'Court': return QQN::Cases()->Court;
				case 'CaseStatusId': return QQN::Cases()->CaseStatusId;
				case 'CaseStatus': return QQN::Cases()->CaseStatus;
				case 'PrimaryPersonId': return QQN::Cases()->PrimaryPersonId;
				default: throw new QCallerException('Simple Property not found in CasesDataGrid content: ' . $mixContent);
