	...
	class RelationshipMetaControlGen extends QBaseClass {
		...
		public function lstPerson_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objPerson = Person::InstantiateCursor($objPersonCursor)) {
				...
				if (($this->objRelationship->Person) && ($this->objRelationship->Person->VictimWitnessNum == $objPerson->VictimWitnessNum))
		...
		public function lstRelatedToPerson_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objRelatedToPerson = Person::InstantiateCursor($objRelatedToPersonCursor)) {
				$objListItem = new QListItem($objRelatedToPerson->__toString(), $objRelatedToPerson->VictimWitnessNum);
				if (($this->objRelationship->RelatedToPerson) && ($this->objRelationship->RelatedToPerson->VictimWitnessNum == $objRelatedToPerson->VictimWitnessNum))
					$objListItem->Selected = true;
		...
		public function lstRelationshipType_Create($strControlId = null) {
			...
			$this->lstRelationshipType->AddItem(QApplication::Translate('- Select One -'), null);
