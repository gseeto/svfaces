<?php
	 ...
	 * must create a new QForm or QPanel which instantiates a LanguageMetaControl
	 * class.
	 *
	...
	class LanguageMetaControlGen extends QBaseClass {
		// General Variables
		/**
		...
		// Controls that allow the editing of Language's individual data fields
        /**
         * @var QLabel lblId;
         * @access protected
         */
		...
		// Controls that allow the viewing of Language's individual data fields
        /**
         * @var QLabel lblName
         * @access protected
         */
		 ...
		 * LanguageMetaControl to edit a single Language object within the
		 * QPanel or QForm.
		 *
		 * This constructor takes in a single Language object, while any of the static
		 * create methods below can be used to construct based off of individual PK ID(s).
		 *
		 * @param mixed $objParentObject QForm or QPanel which will be using this LanguageMetaControl
		 ...
		 */
		 public function __construct($objParentObject, Language $objLanguage) {
			// Setup Parent Object (e.g. QForm or QPanel which will be using this LanguageMetaControl)
		 ...
		 * @param QMetaControlCreateType $intCreateType rules governing Language object creation - defaults to CreateOrEdit
 		 * @return LanguageMetaControl
		 */
		public static function Create($objParentObject, $intId = null, $intCreateType = QMetaControlCreateType::CreateOrEdit) {
			...
			if (strlen($intId)) {
				...
				if ($objLanguage)
					return new LanguageMetaControl($objParentObject, $objLanguage);

				// If CreateOnRecordNotFound not specified, throw an exception
				else if ($intCreateType != QMetaControlCreateType::CreateOnRecordNotFound)
					throw new QCallerException('Could not find a Language object with PK arguments: ' . $intId);
			...
			return new LanguageMetaControl($objParentObject, new Language());
		}
		...
		public static function CreateFromPathInfo($objParentObject, $intCreateType = QMetaControlCreateType::CreateOrEdit) {
			...
			return LanguageMetaControl::Create($objParentObject, $intId, $intCreateType);
		}
		...
		public function lblId_Create($strControlId = null) {
			...
			if ($this->blnEditMode)
				$this->lblId->Text = $this->objLanguage->Id;
			else
				$this->lblId->Text = 'N/A';
			return $this->lblId;
		}
		...
		/**
		 * Refresh this MetaControl with Data from the local Language object.
		...
		public function Refresh($blnReload = false) {
			...
			if ($this->lblId) if ($this->blnEditMode) $this->lblId->Text = $this->objLanguage->Id;
		...
		///////////////////////////////////////////////
		// PUBLIC LANGUAGE OBJECT MANIPULATORS
		///////////////////////////////////////////////
