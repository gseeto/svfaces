<?php
	 ...
	 * listing a collection of Advocate objects.  It includes
	 ...
	 * 
	 */
	class AdvocateDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Advocate datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Advocate object, or it can be any QQNode extending from QQN::Advocate().
		 * 
		 ...
		 * sorting using two fields from the Advocate object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Advocate
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Advocate::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Advocate, given the clauses above
			$this->DataSource = Advocate::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Advocate-based QQNode.
		 * It will also verify that it is a proper Advocate-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'advocate') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "advocate".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Advocate()->Id;
				case 'LoginId': return QQN::Advocate()->LoginId;
				case 'Login': return QQN::Advocate()->Login;
				case 'GrantId': return QQN::Advocate()->GrantId;
				case 'Grant': return QQN::Advocate()->Grant;
				default: throw new QCallerException('Simple Property not found in AdvocateDataGrid content: ' . $mixContent);
