...
CREATE TABLE `case_advocate_assn`
(
`case_id` INTEGER NOT NULL,
...
CREATE INDEX `advocate_id_idx` ON `case_advocate_assn`(`advocate_id`);
ALTER TABLE `case_advocate_assn` ADD FOREIGN KEY advocate_id_idxfk (`advocate_id`) REFERENCES `advocate` (`id`);

CREATE INDEX `case_id_idx` ON `case_advocate_assn`(`case_id`);
ALTER TABLE `case_advocate_assn` ADD FOREIGN KEY case_id_idxfk (`case_id`) REFERENCES `cases` (`id`);
